...
import organizationMockedResponse_seats from '../assets/organization_seats_response_sample.json';
import enterpriseMockedResponse_seats from '../assets/enterprise_seats_response_sample.json';
