...
import organizationMockedResponse_seats from '../../mock-data/organization_response_sample_seats.json';
import enterpriseMockedResponse_seats from '../../mock-data/enterprise_response_sample_seats.json';
