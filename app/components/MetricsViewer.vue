  ...
  <div>
          ...
          <div class="tiles-text">
            ...
            <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
              ...
              <v-card class="pa-3 metric-tooltip">
                  <span class="tooltip-text">The ratio of accepted code completions to total code completions generated by GitHub Copilot. This rate indicates the relevance and usefulness of Copilot's inline code suggestions. Note: each count represents one completion interaction, not individual suggestion items.</span>
              </v-card>
            </v-tooltip>
      ...
      <v-card elevation="4" color="white" variant="elevated" class="mx-auto my-3" style="width: 300px; height: 175px;">
        <v-card-item>
          <div class="tiles-text">
            ...
            <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
              <template #activator="{ props }">
                <div v-bind="props" class="text-h6 mb-1">Total Code Completions</div>
              </template>
              <v-card class="pa-3 metric-tooltip">
                <span class="tooltip-text">Total number of code completion interactions generated by GitHub Copilot. Each count represents one completion event (which may contain multiple code blocks). This reflects inline code suggestion activity only, excluding chat and agent interactions.</span>
              </v-card>
            </v-tooltip>
              <div class="text-caption">
              {{ dateRangeDescription }}
          ...
          <v-card-item>
            ...
            <div class="tiles-text">
              <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
                ...
                <v-card class="pa-3 metric-tooltip">
                  <span class="tooltip-text">The ratio of accepted lines of code to total lines suggested by Copilot's inline code completions. Only includes code completion activity (excludes agent edits and chat).</span>
                </v-card>
              </v-tooltip>
              <div class="text-caption">
                {{ dateRangeDescription }}
        ...
        <v-card-item>
          <div class="tiles-text">
            ...
            <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
              ...
              <v-card class="pa-3 metric-tooltip">
                <span class="tooltip-text">Showcases the total number of lines of code suggested by GitHub Copilot. This gives an idea of the volume of code generation and assistance provided.</span>
              </v-card>
            </v-tooltip>
            <div class="text-caption">
              {{ dateRangeDescription }}
    ...
    <v-main class="p-1" style="min-height: 300px;">
      ...
      <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
        ...
        <v-card class="pa-3 metric-tooltip">
          <span class="tooltip-text">The ratio of accepted code completions to total code completions generated by GitHub Copilot. Each count represents one completion interaction.</span>
        </v-card>
      </v-tooltip>
      ...
      <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
        ...
        <v-card class="pa-3 metric-tooltip">
          <span class="tooltip-text">Daily count of inline code completion events generated vs accepted by users. Each event represents one code suggestion interaction.</span>
        </v-card>
      </v-tooltip>
      ...
      <v-tooltip location="bottom start" open-on-hover open-delay="200" close-delay="200">
        ...
        <v-card class="pa-3 metric-tooltip">
          <span class="tooltip-text">The ratio of accepted lines of code to total lines suggested by Copilot's inline code completions. Only includes code completion activity.</span>
        </v-card>
      </v-tooltip>
