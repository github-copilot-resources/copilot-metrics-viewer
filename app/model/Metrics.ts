...
// Generated by Copilot: Define team interface for consistent team data structure
export interface Team {
  name: string;
  slug: string;
}

// Generated by Copilot: Define team metrics data structure for API responses
export interface TeamMetricData {
  team: Team;
  metrics: Metrics[];
}

// Generated by Copilot: Define extended metrics type that includes team information
export interface TeamAwareMetrics extends Metrics {
  team: string;     // Team name for display purposes
  teamSlug: string; // Team slug for unique identification and filtering
}